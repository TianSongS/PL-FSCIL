...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--inc_epochs', default=50, type=int)
    subparsers.add_argument('--norm_loss_factor', default=0.1, type=float)
    ...
    # FSCIL
    subparsers.add_argument('--batch_size_base', type=int, default=96, help='batch_size')
    subparsers.add_argument('--test_batch_size', type=int, default=25)
    subparsers.add_argument('--batch_size_new', type=int, default=25, help='set 0 will use all the availiable training image for new')