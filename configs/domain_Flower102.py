...
def get_args_parser(subparsers):
    ...
    # dataset
    subparsers.add_argument('--nb_classes', default=102, type=int)
    ...
    subparsers.add_argument('--dataset', default='Flower102', type=str, help='dataset name')
    ...
    subparsers.add_argument('--use_f_prompt', default=False, type=bool, help='if using the E-Prompt')
    subparsers.add_argument('--f_prompt_layer_idx', default=[], type=int, nargs = "+", help='the layer index of the E-Prompt')
    subparsers.add_argument('--use_prefix_tune_for_f_prompt', default=True, type=bool, help='if using the prefix tune for E-Prompt')

    # Use prompt pool implement Domain-Prompt
