...
def get_args_parser(subparsers):
    ...
    # dataset
    subparsers.add_argument('--nb_classes', default=257, type=int)
    subparsers.add_argument('--dataset', default='Caltech256', type=str, help='dataset name')
    # Model parameters
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default=' ', type=str, help='dataset path')
    ...
    subparsers.add_argument('--use_d_prompt', default=True, type=bool, help='if using Domain-Prompt')
    subparsers.add_argument('--d_prompt_length', default=5, type=int, help='length of Domain-Prompt')
    subparsers.add_argument('--d_prompt_layer_idx', default=[0, 1], type=int, nargs = "+", help='the layer index of the Domain-Prompt')
    subparsers.add_argument('--use_prefix_tune_for_d_prompt', default=True, type=bool, help='if using the prefix tune for Domain-Prompt')
    
    # FSCIL-Prompt parameters
    subparsers.add_argument('--use_f_prompt', default=False, type=bool, help='if using the FSCIL-Prompt')
    subparsers.add_argument('--f_prompt_layer_idx', default=[], type=int, nargs = "+", help='the layer index of the FSCIL-Prompt')
    subparsers.add_argument('--use_prefix_tune_for_f_prompt', default=True, type=bool, help='if using the prefix tune for FSCIL-Prompt')
